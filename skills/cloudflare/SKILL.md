...
| Pages | Compute & Runtime |
| Durable Objects | Compute & Runtime |
| Workflows | Compute & Runtime |
| Containers | Compute & Runtime |
| KV | Storage & Data |
| D1 | Storage & Data |
| R2 | Storage & Data |
| Queues | Storage & Data |
| Workers AI | AI & Machine Learning |
| Vectorize | AI & Machine Learning |
| Agents SDK | AI & Machine Learning |
| AI Gateway | AI & Machine Learning |
| WAF | Security |
| DDoS Protection | Security |
| Turnstile | Security |
| Tunnel | Networking & Connectivity |
| Wrangler | Developer Tools |
| Miniflare | Developer Tools |
| Terraform | Infrastructure as Code |
| Pulumi | Infrastructure as Code |

## Cost & Limits Awareness

Always check current Cloudflare pricing and limits before making architecture recommendations:
- Workers: CPU time, subrequests, memory, duration
- D1: read/write rows, storage, queries/sec
- R2: storage, class A/B operations, egress
- Queues: throughput, batch size, retention
- Workers AI: model-specific per-token or per-call pricing
- Vectorize: vector dimensions, index size, query QPS
